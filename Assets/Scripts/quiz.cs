...
public class quiz : MonoBehaviour
{
    ...
    void Start()
    {
        //correctAnsAudio = quizCanvas.transform.GetComponent<AudioSource>();
    ...
    IEnumerator ShowNextQuestion()
    {
        ...
        ButtonColor.color = new Color32(0, 54, 201, 255);       // Revert color back to white
    ...
    IEnumerator ShowRedAlert()
    {
        ...
        //AlertScreen.SetActive(true);
        //quizCanvas.transform.Find("WrongAnsAudio").GetComponent<AudioSource>().enabled = true;
